...
const useStyles = createUseStyles({
    ...
    moduleContainer: {
        ...
        borderRadius: '30px',
        background: 'radial-gradient(ellipse at top, rgba(232, 232, 185, 0) 1%, rgba(207, 194, 213, .4)), radial-gradient(ellipse at bottom, rgba(185, 221, 232, .92), transparent)',
        //color: 'white',
...
const Landing = () => {
    ...
    const animateBackground = () => {
        ...
        if (window.scrollY === 0) {
            ...
            clouds2.style.opacity = .6
            landscape.style.opacity = .6
        }

        if (window.screen.availWidth === 1024) {
            starsBack.style.top = value1 * .25 + 'px'
            starsFront.style.top = value1 * .5 + 'px'
            clouds1.style.top = value2 * .15 + 'px'
            clouds2.style.top = value3 * .24 + 'px'
            landscape.style.top = value4 * .40 + 'px'
        } else {
            starsBack.style.top = value1 * .25 + 'px'
            starsFront.style.top = value1 * .5 + 'px'
            clouds1.style.top = value2 * .15 + 'px'
            clouds2.style.top = value3 * .25 + 'px'
            landscape.style.top = value4 * .43 + 'px'
        }
        
        logo.style.filter = `drop-shadow(10px ${10 - (value1*.03)}px 1px #443356)`
        greeting.style.filter = `drop-shadow(10px ${10 - value1*.03}px 1px #443356)`
    }
        ...
        <>
            ...
            <div className={classes.contentContainer}>
                ...
                <div className={classes.moduleContainer}>
                    ...
                    <div >
                        <p className={classes.moduleText}>Thursday nights are all about coming together to support each other in the physical realm while we venture within to receive individual guidance in the energetic realm.<br/>
                        ...
                        <br/>We currently have room for only 7, so click over to the Booking page to reserve your spot!</p>
                    </div>
                ...
                <div className={classes.moduleContainer}>
                    ...
                    <p className={classes.moduleText}>Put simply, Energy Healing is the means by which we restore energetic harmony within ourselves, to promote peace and well-being. It is a holistic approach to healing the mind and body, predicated upon the understanding that they are connected energetically in a powerful way. This connection is intricate and dynamic, yet fragile in that an imbalance of the energies within us will manifest physical and mental ailments. Energy Healing practitioners work to restore balance to the energetic body, alleviating the symptoms we experience by treating the root cause.</p>
                    <h2 className={classes.moduleSubtitle}>Reiki</h2>
                    <p className={classes.moduleText}>A large part of the benefits people see from receiving Reiki sessions stems from the cleansing of the Chakras. When they are clear of blocks and negative energy, the body may be able to defend itself against many issues. A Reiki healing session can help to release emotional wounds, relax the body and mind, and energize you when you feel drained, just to name a few of the many possible benefits!</p>
                    <h2 className={classes.moduleSubtitle}>Access Bars</h2>
                    <p className={classes.moduleText}>This healing modality helps to clear the subconscious by releasing beliefs, thought patterns, and emotions that no longer serve us using gentle pressure applied to specific areas of the head. An Access Bars healing session can help to release negative thought patterns and limiting beliefs and allow mental clarity.</p>
                    <div className={classes.buttonContainer}>
                ...
                <div className={classes.moduleContainer}>
                    ...
                    <p className={classes.moduleText}>You may already be familiar with the powerful effects of sound frequencies as they are the basis for modern day meditation music and binaural beats. The same concepts are at play in a sound healing session. Through the use of a variety of instruments such as Tibetan singing bowls, tuning forks, and drums, an atmosphere of specific vibratory resonance is applied to the physical and etheric body, restoring harmony and balance within each. These sessions may:</p>
                    <ul>
                        ...
                        <li className={classes.listItem}>Support mental, emotional, and spiritual well-being</li>
                    </ul>
                </div>
                <div className={classes.moduleContainer}>
                    <h1 className={classes.moduleTitle}>Workshops</h1>
                    <p className={classes.moduleText}>We all have within us the ability to connect with our spiritual nature and access tools to help us along our journey. Our single-day workshops are designed to share knowledge, wisdom, and guidance, aiding in the discovery and cultivation of these tools. Is there a topic you'd like to learn more about? Please let us know!</p>
                </div>
                <h1 className={classes.sectionTitle}>Our Mission</h1>
                <div className={classes.moduleContainer}>
                    <p className={classes.moduleText}>Serenity Ignited, LLC is committed to helping people ignite the fire within themselves to move forward from past traumas and bring serenity to their lives. We strive to empower people to stand in their own sovereignty, allowing them to embrace their true Self, and to provide tools that sustain them on their journey forward as well as a safe space to build their foundation.</p>
                    <div className={classes.buttonContainer}>
