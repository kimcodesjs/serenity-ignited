    ...
    return (
        <div className={classes.accessContainer}>
            ...
            <div className={classes.accessText}>
                ...
                <ul>
                    <li className={classes.listItem}>Releases the beliefs you have agreed to hold as your own, but are not true</li>
                    <li className={classes.listItem}>Cleans out energetic imprints that emotions and feelings have left in your mind from traumatic or unpleasant situations</li>
                    <li className={classes.listItem}>Can bring the limiting beliefs you have into your awareness so you can choose different if they no longer make sense</li>
                    <li className={classes.listItem}>Leaves you opportunities to bring peace, joy, and happiness into your life with ease</li>
                    <li className={classes.listItem}>Supports your ability to release stress and anxiety</li>
                    <li className={classes.listItem}>Reduces, or even eliminates, the constant mental chatter which allows for more mental clarity</li>
                    <li className={classes.listItem}>Releases negative thought patterns that are holding you back from the life you have dreamt of having</li>
                    <li className={classes.listItem}>Assists you in seeing the potential you hold as an infinite being</li>
                </ul>
